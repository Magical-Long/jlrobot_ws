...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description="YAML parameter file for the pose-to-effort control bridge.",
        ),
        DeclareLaunchArgument(
            "urdf_path",
            default_value=default_urdf_path,
            description="URDF path used by robot_core for IK and effort-side joint target generation.",
        ),
        DeclareLaunchArgument(
            "end_effector_frame",
